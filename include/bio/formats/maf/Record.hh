...
#ifndef __BIO_FORMATS_MAF_RECORD_HH__
#define __BIO_FORMATS_MAF_RECORD_HH__
...
namespace bio { namespace formats { namespace maf {
    ...
    struct Record : public VariableMap,
					public alignment::IntervalMultipleAlignment {
		...
		genome::BasicInterval getInterval(size_t seqNum) const;
	};

} } }

#endif // __BIO_FORMATS_MAF_RECORD_HH__
