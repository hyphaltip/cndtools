...
#ifndef __SCORING_VISITOR_HH__
#define __SCORING_VISITOR_HH__

#include "graph_types.hh"

class ScoringVisitor : public default_dfs_visitor {
private:
	...
	void addScores(BreakpointSegment* seg1,
				   BreakpointSegment* seg2,
				   AlignedSegments* alignment);
	
public:
    ScoringVisitor(Graph& g);

	void finish_vertex(Vertex u, const Graph& g);
};

#endif // __SCORING_VISITOR_HH__
